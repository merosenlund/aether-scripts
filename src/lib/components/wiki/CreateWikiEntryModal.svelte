		...
		>
			...
			<div data-component="modal-footer" class="flex gap-3 pt-2">
				<button
					...
					disabled={isCreating}
					class="bg-primary text-primary-foreground flex flex-1 items-center justify-center rounded-xl py-2.5 text-xs font-bold transition-opacity hover:opacity-90 disabled:opacity-50"
				>
					{#if isCreating}
